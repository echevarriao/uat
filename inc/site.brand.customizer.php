...
function signature_brand_customizer($wp_customize){
    ...
    $wp_customize->add_setting('brand_bg_type', array('default' => 'default'));
	...
	'label'        => __( 'Solid Backrgound Color', 'eversource' ),
	'section'    => 'site_branding_section',
	...
	'label'        => __( '"UCONN" Text Color', 'eversource' ),
	'section'    => 'site_branding_section',
	...
	'label'        => __( 'Separator "|" Text Color', 'eversource' ),
	'section'    => 'site_branding_section',
	...
	'label'        => __( '"University of Connecticut" Text Color', 'eversource' ),
	'section'    => 'site_branding_section',
