...
function subfooter_brand_customizer($wp_customize){
    ...
    $wp_customize->add_setting('subfooter_branding_display_type', array('default' => 'show'));
    ...
    new WP_Customize_Control(
        ...
        array(
            'label'          => __( 'Display Subfooter Toggle', 'eversource' ),
    ...
    $wp_customize->add_setting('subfooter_branding_bg_type', array('default' => 'default'));
